...
The animation control code, camera flow, character physics and a lot of other things need to be fixed up... in general it's really glitchy right now, but I was surprised how easy it was to get my 2D character controller to interact properly with the 3D environment.
